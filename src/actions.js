  ...
  initActions: function () {
    ...
    actions.input_assign = {
      ...
      callback: async function (action) {
        ...
        let address =
          "00" +
          "00" +
          options.input.toString(16).padStart(2, "0").toUpperCase();
    ...
    actions.output_assign = {
      ...
      callback: async function (action) {
        ...
        address +=
          "00" + options.output.toString(16).padStart(2, "0").toUpperCase();
    ...
    actions.pnpkey_enable = {
      ...
      callback: async function (action) {
        ...
        let address =
          "00" +
          "00" +
          options.pinp.toString(16).padStart(2, "0").toUpperCase();
    ...
    actions.set_dsk_key_source = {
      ...
      callback: async function (action) {
        let options = action.options;
        let address =
          "00" + options.dsk.toString(16).padStart(2, "0").toUpperCase() + "04";
        let value = options.assign.toString(16).padStart(2, "0").toUpperCase();
        self.sendCommand(address, value);
      },
    };
    ...
    actions.set_dsk_fill_source = {
      ...
      callback: async function (action) {
        let options = action.options;
        let address =
          "00" + options.dsk.toString(16).padStart(2, "0").toUpperCase() + "05";
        let value = options.assign.toString(16).padStart(2, "0").toUpperCase();
        self.sendCommand(address, value);
      },
    };
    ...
    actions.set_dsk_type = {
      ...
      callback: async function (action) {
        let options = action.options;
        let address =
          "00" + options.dsk.toString(16).padStart(2, "0").toUpperCase() + "06";
        let value = options.key.toString(16).padStart(2, "0").toUpperCase();
        self.sendCommand(address, value);
      },
    };
